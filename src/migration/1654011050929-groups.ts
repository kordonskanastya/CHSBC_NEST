...
export class groups1654011050929 implements MigrationInterface {
    name = 'groups1654011050929'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "groups" ADD CONSTRAINT "FK_586bdb4687e22b93b708e3c670d" FOREIGN KEY ("curatorIdId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
